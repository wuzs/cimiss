    ...
    var e = function() {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                ...
                a[5].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[6].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[7].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[8].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[9].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[10].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[11].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[12].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',
                a[13].innerHTML = '<input type="text" class="form-control input-small" value="' + n[3] + '">',



                a[14].innerHTML = '<a class="edit" href="">Save</a>', a[15].innerHTML = '<a class="cancel" href="">Cancel</a>'
        }
